...
class AxCode < Formula
  ...
  on_macos do
    ...
    url "https://github.com/defai-digital/ax-code/releases/download/v6.11.0/ax-code-darwin-arm64.zip"
    sha256 "96c3dde93f7556e3b8597d79148f66c0f2011fae8b773a45f9964f50dca6af3d"
  end

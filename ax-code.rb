...
class AxCode < Formula
  ...
  on_macos do
    ...
    url "https://github.com/defai-digital/ax-code/releases/download/v6.9.5/ax-code-darwin-arm64.zip"
    sha256 "6ff76211cde8674e2f28ce12036b19592d9dc3590cd5e1e8623acb0b9c0037f7"
  end

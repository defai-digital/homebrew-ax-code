...
class AxCode < Formula
  ...
  on_macos do
    ...
    url "https://github.com/defai-digital/ax-code/releases/download/v6.7.14/ax-code-darwin-arm64.zip"
    sha256 "e0abc9a90a8afbd86b19303500c1e505030237356511d92f36ce985cc93feef4"
  end

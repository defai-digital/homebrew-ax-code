...
class AxCode < Formula
  ...
  on_macos do
    ...
    url "https://github.com/defai-digital/ax-code/releases/download/v6.9.0/ax-code-darwin-arm64.zip"
    sha256 "ee2ef234cf907a38939bd22159668c087d287aa3cc6bc6b9949f611ce4ab7df6"
  end

...
class AxCode < Formula
  ...
  on_macos do
    ...
    url "https://github.com/defai-digital/ax-code/releases/download/v6.7.13/ax-code-darwin-arm64.zip"
    sha256 "38fa325e9d23354721a41a6c613f22d61851e66243d276d80d6dd201a5f4a0a4"
  end

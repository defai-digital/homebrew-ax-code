...
class AxCode < Formula
  ...
  on_macos do
    ...
    url "https://github.com/defai-digital/ax-code/releases/download/v6.7.17/ax-code-darwin-arm64.zip"
    sha256 "1d84b19879a2db33281b14a730918de1e852160047543291aca9fdd051410d02"
  end

...
class AxCode < Formula
  ...
  on_macos do
    ...
    url "https://github.com/defai-digital/ax-code/releases/download/v7.0.1/ax-code-darwin-arm64.zip"
    sha256 "673b867e377dde3577b5cb2b9361f30570da2e2deb21c4de29d5722938e0037b"
  end

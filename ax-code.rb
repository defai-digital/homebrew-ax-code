...
class AxCode < Formula
  ...
  on_macos do
    ...
    url "https://github.com/defai-digital/ax-code/releases/download/v6.8.1/ax-code-darwin-arm64.zip"
    sha256 "ad81eaf3da9913e3cad305ae518c0dac252d63d5d73ae246910d5b16c9ab1a27"
  end

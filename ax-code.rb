...
class AxCode < Formula
  ...
  on_macos do
    ...
    url "https://github.com/defai-digital/ax-code/releases/download/v6.8.4/ax-code-darwin-arm64.zip"
    sha256 "9153c3e32672feb8b3e6dd0ce303797a33e7f4933788bb2a350290f51f7e3477"
  end

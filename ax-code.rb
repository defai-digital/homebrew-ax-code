...
class AxCode < Formula
  ...
  on_macos do
    ...
    url "https://github.com/defai-digital/ax-code/releases/download/v6.7.9/ax-code-darwin-arm64.zip"
    sha256 "da30ab26b261e3793af4d5e347dfabcd144e7f0127334eee0be452ef497e17f8"
  end

...
class AxCode < Formula
  ...
  on_macos do
    ...
    url "https://github.com/defai-digital/ax-code/releases/download/v6.7.8/ax-code-darwin-arm64.zip"
    sha256 "4e2385f858ca45acf848fdc01c567db9a6777f7598c80887900c3b8ad45a1815"
  end

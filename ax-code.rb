...
class AxCode < Formula
  ...
  on_macos do
    ...
    url "https://github.com/defai-digital/ax-code/releases/download/v7.0.0/ax-code-darwin-arm64.zip"
    sha256 "ee62c44851b85e7020d422b4d3cf3c8fd3f9e396bebf2ca4eeea007fe9391329"
  end

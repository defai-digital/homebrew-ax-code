...
class AxCode < Formula
  ...
  on_macos do
    ...
    url "https://github.com/defai-digital/ax-code/releases/download/v6.7.6/ax-code-darwin-arm64.zip"
    sha256 "e495c4b93af82036eb0adf3ee3929bd752d03ef554d79e5078916febbac2875e"
  end

...
class AxCode < Formula
  ...
  on_macos do
    ...
    url "https://github.com/defai-digital/ax-code/releases/download/v6.9.8/ax-code-darwin-arm64.zip"
    sha256 "0f3839c8cdda086748321b7e051d0489c61fab51609a994a4f8165cd40a2d336"
  end

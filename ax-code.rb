...
class AxCode < Formula
  ...
  on_macos do
    ...
    url "https://github.com/defai-digital/ax-code/releases/download/v6.7.15/ax-code-darwin-arm64.zip"
    sha256 "dd8ff9332a84ecacb04606f1deba2fb5edb80489be35290c62b82f6b00a2d720"
  end

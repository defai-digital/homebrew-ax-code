...
class AxCode < Formula
  ...
  on_macos do
    ...
    url "https://github.com/defai-digital/ax-code/releases/download/v6.9.4/ax-code-darwin-arm64.zip"
    sha256 "509f9eb43e38f01f5e995a1b7ec7bcd3076dd36daae155e03cc402e3a3a33aa6"
  end

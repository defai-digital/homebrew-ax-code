...
class AxCode < Formula
  ...
  on_macos do
    ...
    url "https://github.com/defai-digital/ax-code/releases/download/v6.7.20/ax-code-darwin-arm64.zip"
    sha256 "5b13fbc4d9313024a63eb53c649b1ebc0920acd94432331055a07518101d3c82"
  end

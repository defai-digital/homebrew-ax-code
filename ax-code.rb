...
class AxCode < Formula
  ...
  on_macos do
    ...
    url "https://github.com/defai-digital/ax-code/releases/download/v6.8.3/ax-code-darwin-arm64.zip"
    sha256 "50db3789494428de72b47e5c9a5c3561e32447f1a0db454fdc876d398ed2552a"
  end

...
class AxCode < Formula
  ...
  on_macos do
    ...
    url "https://github.com/defai-digital/ax-code/releases/download/v6.9.3/ax-code-darwin-arm64.zip"
    sha256 "02a7332ef41e2484e4e49bb4045980b1c5b11a4a6c2d4e70a9d4d87f5cd69919"
  end

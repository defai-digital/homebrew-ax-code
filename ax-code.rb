...
class AxCode < Formula
  ...
  on_macos do
    ...
    url "https://github.com/defai-digital/ax-code/releases/download/v6.7.10/ax-code-darwin-arm64.zip"
    sha256 "2b94fc6766acbb89d6cc8b6ea76e2198d3edfa29dc041b155bc4be426b64fffb"
  end

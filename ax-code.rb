...
class AxCode < Formula
  ...
  on_macos do
    ...
    url "https://github.com/defai-digital/ax-code/releases/download/v6.7.19/ax-code-darwin-arm64.zip"
    sha256 "c627976a6ad7616115f1c95ffb709ec895257a2cca7a2b1e0f714e5ce68f828e"
  end

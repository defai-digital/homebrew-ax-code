...
class AxCode < Formula
  ...
  on_macos do
    ...
    url "https://github.com/defai-digital/ax-code/releases/download/v6.9.6/ax-code-darwin-arm64.zip"
    sha256 "c49479e3b2a19f4c3081eb7911ed64d14041d040dd69af1b9cebc809ec6903e5"
  end

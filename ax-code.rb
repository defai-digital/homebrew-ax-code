...
class AxCode < Formula
  ...
  on_macos do
    ...
    url "https://github.com/defai-digital/ax-code/releases/download/v6.9.7/ax-code-darwin-arm64.zip"
    sha256 "25cd272efc9975b9110897616f94f13d76a4b01c2d075c7ce14bb18b85d37b81"
  end

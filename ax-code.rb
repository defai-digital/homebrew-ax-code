...
class AxCode < Formula
  ...
  on_macos do
    ...
    url "https://github.com/defai-digital/ax-code/releases/download/v6.7.18/ax-code-darwin-arm64.zip"
    sha256 "b784e5f8ea8e41bcebd190adb40825cb134b0c44221fe9b0248ca36da4c137da"
  end

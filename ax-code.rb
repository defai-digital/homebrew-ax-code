...
class AxCode < Formula
  ...
  on_macos do
    ...
    url "https://github.com/defai-digital/ax-code/releases/download/v6.7.5/ax-code-darwin-arm64.zip"
    sha256 "1dcda50fbb8374e323c609c9bd9f5411529fb246b44bd850c390df9c51eb113c"
  end

...
class AxCode < Formula
  ...
  on_macos do
    ...
    url "https://github.com/defai-digital/ax-code/releases/download/v6.10.1/ax-code-darwin-arm64.zip"
    sha256 "852645aa577d1ccf7d2eb6a10a27a19b590a786fac9b6dcefbed24e694e4e59f"
  end

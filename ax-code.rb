...
class AxCode < Formula
  ...
  on_macos do
    ...
    url "https://github.com/defai-digital/ax-code/releases/download/v6.10.0/ax-code-darwin-arm64.zip"
    sha256 "f25797e74179c3531df0a4f806ec85d017412af8f0d262296e58ca5e85cb9445"
  end

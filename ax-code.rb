...
class AxCode < Formula
  ...
  on_macos do
    ...
    url "https://github.com/defai-digital/ax-code/releases/download/v6.8.2/ax-code-darwin-arm64.zip"
    sha256 "2036dd0d6f6932699af2e93146690a363487d435b23a91fda98cff50316b1abd"
  end

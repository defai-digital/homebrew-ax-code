...
class AxCode < Formula
  ...
  on_macos do
    ...
    url "https://github.com/defai-digital/ax-code/releases/download/v6.8.5/ax-code-darwin-arm64.zip"
    sha256 "e4bab7192edf8020ec5ed67c0504c5eb1c7941b7be0cdcf66ce2b1196c5b4991"
  end

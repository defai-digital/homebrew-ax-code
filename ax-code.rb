...
class AxCode < Formula
  ...
  on_macos do
    ...
    url "https://github.com/defai-digital/ax-code/releases/download/v6.7.7/ax-code-darwin-arm64.zip"
    sha256 "8e5b4ed4e329e90e7fd52010b7262407f301670bb781f5cf4b6970f11a42396f"
  end

...
class AxCode < Formula
  ...
  on_macos do
    ...
    url "https://github.com/defai-digital/ax-code/releases/download/v6.7.16/ax-code-darwin-arm64.zip"
    sha256 "b73e62ebe940941cd01e5a57e615fc77676b49df22d904d7ef57375cf844e39e"
  end
